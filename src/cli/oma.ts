...
const PROVIDER_REFERENCE: ReadonlyArray<{
  ...
  { id: 'litellm', apiKeyEnv: ['LITELLM_API_KEY'], baseUrlSupported: true, notes: 'Local or remote LiteLLM proxy (default: http://localhost:4000). Set LITELLM_BASE_URL for remote deployments. LITELLM_API_KEY is optional for unauthenticated local proxies.' },
  {
    id: 'copilot',
